import{M as x,a6 as ae,R as c,o as de,j as C,r as j,l as y,m as d,x as _,k as ue,v as D,C as g,D as L,a2 as he,E as U,O as R,z as F,n as pe,S as O,P as z,T as me,a7 as fe,a8 as we}from"./index-BHAdRtQm.js";import{c as w,n as l,r as u,U as ne}from"./index-DFGJhMsg.js";import{o as W}from"./if-defined-C_Vgpgz-.js";import"./index-DYTQAgvT.js";import"./index-CBY904Gk.js";import{H as ee}from"./HelpersUtil-BbMGzs2i.js";import{C as V}from"./ConstantsUtil-COJBkkkj.js";import"./index-D3-7elvK.js";import"./index-emJqCrtV.js";import"./index-DkitUOzK.js";import"./index-DcFtPqCY.js";import{S as be}from"./SwapController-u6tGuYfy.js";import"./index-R8DbRnD7.js";import"./index-BkoV1bZ6.js";import"./index-wXc_POO8.js";import"./index-BRI6Kknk.js";const se={isUnsupportedChainView(){return c.state.view==="UnsupportedChain"||c.state.view==="SwitchNetwork"&&c.state.history.includes("UnsupportedChain")},async safeClose(){if(this.isUnsupportedChainView()){x.shake();return}if(await ae.isSIWXCloseDisabled()){x.shake();return}(c.state.view==="DataCapture"||c.state.view==="DataCaptureOtpConfirm")&&de.disconnect(),x.close()}},ge=C`
  :host {
    display: block;
...
`;var X=function(e,t,i,r){var a=arguments.length,o=a<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,i):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,i,r);else for(var s=e.length-1;s>=0;s--)(n=e[s])&&(o=(a<3?n(o):a>3?n(t,i,o):n(t,i))||o);return a>3&&o&&Object.defineProperty(t,i,o),o};const xe={info:"info",success:"checkmark",warning:"warningCircle",error:"warning"};let N=class extends y{constructor(){super(...arguments),this.message="",this.type="info"}render(){return d`
    ...
    `}onClose(){_.close()}};N.styles=[j,ve];X([l()],N.prototype,"message",void 0);X([l()],N.prototype,"type",void 0);N=X([w("wui-alertbar")],N);const ke=C`
  :host {
    display: block;
    position: absolute;
    top: ${({spacing:e})=>e[3]};
...
`;var Y=function(e,t,i,r){var a=arguments.length,o=a<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,i):r,n;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,i,r);else for(var s=e.length-1;s>=0;s--)(n=e[s])&&(o=(a<3?n(o):a>3?n(t,i,o):n(t,i))||o);return a>3&&o&&Object.defineProperty(t,i,o),o};let T=class extends y{constructor(){super(...arguments),this.message="",this.variant="success"}render(){return d`
    ...
    `}templateIcon(){const t={success:"success",error:"error",warning:"warning",info:"default"},i={success:"checkmark",error:"warning",warning:"warningCircle",info:"info"};return this.variant==="loading"?d`<wui-loading-spinner size="md" color="accent-primary"></wui-loading-spinner>`:d`<wui-icon-box
      ...
      icon=${i[this.variant]}
    ></wui-icon-box>`}};T.styles=[j,Oe];Y([l()],T.prototype,"message",void 0);Y([l()],T.prototype,"variant",void 0);T=Y([w("wui-snackbar")],T);const Ae=pe`
  :host {
    display: block;
    position: absolute;
    opacity: 0;
