import{w as d,p as h,s as f,i as g,j as w,l as b,m as y}from"./index-BHAdRtQm.js";import{r as m,c as v}from"./index-DFGJhMsg.js";const o=h({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),x={state:o,subscribe(t){return g(o,()=>t(o))},subscribeKey(t,e){return f(o,t,e)},showTooltip({message:t,triggerRect:e,variant:i}){o.open=!0,o.message=t,o.triggerRect=e,o.variant=i},hide(){o.open=!1,o.message="",o.triggerRect={width:0,height:0,top:0,left:0}}},s=d(x),$=w`
  :host {
    pointer-events: none;
  }
...
`;var n=function(t,e,i,p){var l=arguments.length,a=l<3?e:p===null?p=Object.getOwnPropertyDescriptor(e,i):p,c;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")a=Reflect.decorate(t,e,i,p);else for(var u=t.length-1;u>=0;u--)(c=t[u])&&(a=(l<3?c(a):l>3?c(e,i,a):c(e,i))||a);return l>3&&a&&Object.defineProperty(e,i,a),a};let r=class extends b{constructor(){super(),this.unsubscribe=[],this.open=s.state.open,this.message=s.state.message,this.triggerRect=s.state.triggerRect,this.variant=s.state.variant,this.unsubscribe.push(s.subscribe(e=>{this.open=e.open,this.message=e.message,this.triggerRect=e.triggerRect,this.variant=e.variant}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){this.dataset.variant=this.variant;const e=this.triggerRect.top,i=this.triggerRect.left;return this.style.cssText=`
    ...
    </wui-flex>`}};r.styles=[$];n([m()],r.prototype,"open",void 0);n([m()],r.prototype,"message",void 0);n([m()],r.prototype,"triggerRect",void 0);n([m()],r.prototype,"variant",void 0);r=n([v("w3m-tooltip")],r);export{s as T};
